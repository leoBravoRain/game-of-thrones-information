...
export default {
    ...
    methods: {
        onClick() {
            ...
            // console.log(this.house.url.split("/")[5]);
            // go to house details
            // pass house as parameter
            this.$router.push({ 
                name: 'HouseDetails', 
                params: { 
                    house_id: this.house.url.split("/")[5], 
